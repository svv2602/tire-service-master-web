...
export const DrawerSection: React.FC = () => {
  ...
  return (
    <Box>
      ...
      <Card title="Примеры выдвижных панелей">
        <Grid container spacing={4}>
          {/* Разные позиции Drawer */}
          <Grid item xs={12}>
            <Typography gutterBottom>Разные позиции Drawer</Typography>
          ...
          <Grid item xs={12} md={6}>
            <Typography gutterBottom>Временный Drawer</Typography>
            <Button
              variant="contained"
          ...
          {/* Постоянный Drawer */}
          <Grid item xs={12} md={6}>
            <Typography gutterBottom>Постоянный Drawer</Typography>
