...
import { Home as HomeIcon, NavigateNext as NavigateNextIcon, BookOnline as BookIcon } from '@mui/icons-material';
    ...
    <Box sx={{ minHeight: '100vh', bgcolor: colors.backgroundPrimary }}>
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Box sx={{ textAlign: 'center', py: 8 }}>
          <BookIcon sx={{ fontSize: 120, color: colors.textSecondary, mb: 2 }} />
          ...
          <Typography variant="h6" sx={{ color: colors.textSecondary, mb: 4 }}>
            Страница в разработке. Здесь будет форма записи на услуги.
          </Typography>
