...
- [x] **Обновить StyledTableCell в Table.tsx**
  ...
  - [ ] Тестировать на длинных словах (URL, email, имена файлов)
...
- [ ] **Создать файл PageTable.tsx**
  - [ ] Создать папку `src/components/common/PageTable/`
  - [ ] Базовый интерфейс `PageTableProps<T>`
  - [ ] Основная разметка компонента

### 2.2 Заголовок и действия
- [ ] **Компонент PageHeader**
  - [ ] Заголовок страницы
  - [ ] Кнопки действий (Создать, Экспорт и т.д.)
  - [ ] Адаптивная раскладка

### 2.3 Поиск и фильтры
- [ ] **Компонент SearchAndFilters**
...
- [ ] **Интерфейс ActionConfig**
  - [ ] Определить типы действий
  - [ ] Условная видимость действий
  - [ ] Цветовая схема кнопок

- [ ] **Компонент RowActions**
  - [ ] Иконки действий
  - [ ] Tooltips для действий
  - [ ] Hover эффекты
...
### 3.1 Высокий приоритет (4-5 часов)

#### ReviewsPage.tsx
- [ ] **Анализ текущей реализации**
  - [ ] Определить колонки таблицы
  - [ ] Выявить специфичные действия
  - [ ] Проверить фильтрацию и поиск

- [ ] **Миграция на PageTable**
  - [ ] Создать конфигурацию колонок
  - [ ] Настроить действия (Одобрить, Отклонить, Ответить)
  - [ ] Перенести логику фильтрации
...
- [ ] **Анализ и миграция**
  - [ ] Определить колонки
  - [ ] Настроить действия (Редактировать, Удалить)
  - [ ] Перенести фильтры по статусу и дате

- [ ] **Тестирование**
  - [ ] Проверить календарь бронирований
  - [ ] Проверить экспорт данных

#### UsersPage.tsx
- [ ] **Анализ и миграция**
  - [ ] Колонки: Имя, Email, Роль, Статус, Дата регистрации
...
#### PartnersPage.tsx
- [ ] **Миграция**
  - [ ] Колонки: Название, Контакты, Город, Сервисные точки
  - [ ] Действия: Редактировать, Сервисные точки
