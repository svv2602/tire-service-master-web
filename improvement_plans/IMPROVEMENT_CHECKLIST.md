...
- [ ] **Унификация дизайна**
  ...
  - [ ] Внедрить единую тему для всего приложения (/home/snisar/mobi_tz/tire-service-master-web/improvement_plans/THEME_INTEGRATION_PLAN.md)
    ...
    - [ ] Обновить существующие компоненты для использования токенов (28/42 компонентов)
      - [x] Button
      - [x] TextField
      - [x] Card
      - [x] Paper
      ...
      - [x] Progress
      - [x] Skeleton
      - [ ] Специализированные компоненты (0/14)
...
3. Унификация дизайна - **В процессе**
   ...
   - ⏳ Внедрение единой темы (97% выполнено)
     ...
     - ⏳ Миграция компонентов (67% выполнено)
       - ✅ Button (полностью)
       - ✅ TextField (полностью)
       - ✅ Card (полностью)
       - ✅ Paper (полностью)
