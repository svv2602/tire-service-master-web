...
- [ ] **Унификация дизайна**
  ...
  - [ ] Внедрить единую тему для всего приложения (/home/snisar/mobi_tz/tire-service-master-web/improvement_plans/THEME_INTEGRATION_PLAN.md)
    ...
    - [ ] Обновить существующие компоненты для использования токенов (19/42 компонентов)
      - [x] Button
      - [x] TextField
      - [x] Card
      - [x] Paper
      ...
      - [x] Switch
      - [x] Accordion
      - [ ] Специализированные компоненты (0/23)
...
3. Унификация дизайна - **В процессе**
   ...
   - ⏳ Внедрение единой темы (87% выполнено)
     ...
     - ⏳ Миграция компонентов (45% выполнено)
       - ✅ Button (полностью)
       - ✅ TextField (полностью)
       - ✅ Card (полностью)
       - ✅ Paper (полностью)
