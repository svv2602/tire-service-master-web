...
- [ ] **Унификация дизайна**
  ...
  - [ ] Внедрить единую тему для всего приложения (/home/snisar/mobi_tz/tire-service-master-web/improvement_plans/THEME_INTEGRATION_PLAN.md)
    ...
    - [ ] Обновить существующие компоненты для использования токенов (22/42 компонентов)
      - [x] Button
      - [x] TextField
      - [x] Card
      - [x] Paper
      ...
      - [x] AppBar
      - [x] Avatar
      - [ ] Специализированные компоненты (0/20)
...
3. Унификация дизайна - **В процессе**
   ...
   - ⏳ Внедрение единой темы (90% выполнено)
     ...
     - ⏳ Миграция компонентов (52% выполнено)
       - ✅ Button (полностью)
       - ✅ TextField (полностью)
       - ✅ Card (полностью)
       - ✅ Paper (полностью)
