...
**Завершено:** 6/24 страниц (25%)  
**Текущий этап:** Неделя 1 - Критически важные страницы + Начало средне-приоритетных
...
**ОБЯЗАТЕЛЬНО убирать фоновые подкладки Paper:**
```tsx
<Paper sx={{
...
### 🎯 СЛЕДУЮЩАЯ: ServicePointsPage
**План:**
- [ ] Card → UI/Card, Tabs → UI/Tabs, FileUpload → UI/FileUpload  
- [ ] **УБРАТЬ фоновые подкладки Paper**
- [ ] Тестирование табов, загрузки, геолокации 